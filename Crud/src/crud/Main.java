...
import javax.swing.*;
class HandlingActionEvent implements ActionListener{  
JTextField tf3;
...
JRadioButton r2=new JRadioButton("No");    
   cb1=new JCheckBox("Create Table");     
        cb2=new JCheckBox("Insert Data");     
        cb3=new JCheckBox("Delete Data");  
         cb4=new JCheckBox("Update Data");  
          cb5=new JCheckBox("View Data");   
        b=new JButton("Procceed");     
        b.addActionListener(this);  
        f.add(r1);f.add(r2);f.add(cb1);f.add(cb2);f.add(cb3);f.add(cb4);f.add(cb5);f.add(b);f.add(tf3);
        String country[]={"Create","Insert","Delete","Update","View"};        
...
public class Main {
    private static final String createTableSQL = "create table userregistrationnn (\r\n" + "  id  int(3) primary key,\r\n"
            + "  name varchar(100),\r\n" + "  email varchar(100),\r\n" + "  address varchar(100),\r\n"
            + "  password varchar(20)\r\n" + "  );";
